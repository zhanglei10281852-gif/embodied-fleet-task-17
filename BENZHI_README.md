...
- 项目：zhanglei10281852-gif/embodied-fleet-task-17
...
./build_benzhi_docker.sh benzhi-task-195-amd64 linux/amd64
./build_benzhi_docker.sh benzhi-task-195-arm64 linux/arm64
docker run -it benzhi-task-195-amd64:latest
docker run -it --platform linux/arm64 benzhi-task-195-arm64:latest
```
